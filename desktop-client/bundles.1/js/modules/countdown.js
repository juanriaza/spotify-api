 ...
 * @param {function=} opt_callback Callback function to be called each second.
 * @param {number=}   opt_interval Number of milliseconds between each tick.
 */
function Countdown(timeout, opt_callback, opt_interval) {

  // Keep the values valid
  timeout = typeof timeout === 'number' ? timeout : 0;
  timeout = timeout < 0 ? 0 : timeout;
  var callback = typeof opt_callback === 'function' ? opt_callback : function() {};
  var interval = typeof opt_interval === 'number' ? opt_interval : 1000;
